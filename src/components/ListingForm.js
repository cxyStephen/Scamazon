            ...
            <div className="container">
                ...
                <form onSubmit={this.handleSubmit}>
                    ...
                    <div className="form-group">
                        <label>
                            Seller:
                            <input className="form-control" name="seller" type="text" value={this.state.seller} onChange={this.handleInputChange}/>
                        </label>
                    </div>
                    <div className="form-group">
                        <label>
                            Quantity:
                            <input className="form-control" name="quantity" type="text" value={this.state.quantity} onChange={this.handleInputChange}/>
                        </label>
                    </div>
                    <div className="form-group">
                        <label>
